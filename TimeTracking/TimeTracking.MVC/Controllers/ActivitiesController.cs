...
namespace TimeTracking.MVC.Controllers
{
    public class ActivitiesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ActivityID,Name,Description,ActivityTypeID,ProjectID")] Activity activity)
        {
            ...
            ViewBag.ProjectID = new SelectList(db.Projects, "ProjectID", "ProjectID", activity.ProjectID);
            return View(activity);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ActivityID,Name,Description,ActivityTypeID,ProjectID")] Activity activity)
        {
            if (ModelState.IsValid)
            {
