...
namespace TimeTracking.MVC.Controllers
{
    public class ActivityTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ActivityTypeID,Name")] ActivityType activityType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ActivityTypeID,Name")] ActivityType activityType)
        {
            if (ModelState.IsValid)
            {
